        ...
        if (ae.getSource() == b7){
         ...
         try{
             ...
             while (rs.next()){
              ...
              JOptionPane.showMessageDialog(null, "RWF "+samount+" Debited successfully");
              setVisible(false);
              new Transaction(pinnumber1).setVisible(true);
             }
         }
